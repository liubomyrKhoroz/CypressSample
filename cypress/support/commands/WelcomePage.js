...
class WelcomePage extends General {
    ...
    selectSwahiliLanguage() {return this}
	...
	selectMobilePhone() {
		cy.get('#normal_login_preferredMethod > :nth-child(1) > span > input').click()
		return this
	}

	selectEmail() {
		cy.get('#normal_login_preferredMethod > :nth-child(2) > span > input').click()
		return this
	}
	...
	selectVisitedBeforeYes() {
		cy.get('#normal_login_returnPatient > :nth-child(1) > span > input').click()
		return this
	}
	...
	selectMedicalPatientYes() {
		cy.get('#normal_login_medicarePatient > :nth-child(1) > span > input').click()
		return this
	}
	...
	verifySwahiliSelected() {return this}

	verifyMobilePhoneSelected() {
		cy.get('#normal_login_preferredMethod > :nth-child(1) > span > input').should('be.checked')
		cy.get('#normal_login_preferredMethod > :nth-child(2) > span > input').should('not.be.checked')
		return this
	}

	verifyEmailSelected() {
		cy.get('#normal_login_preferredMethod > :nth-child(1) > span > input').should('not.be.checked')
		cy.get('#normal_login_preferredMethod > :nth-child(2) > span > input').should('be.checked')
		return this
	}

	verifyGuardianIsEmpty() {
		cy.get('#normal_login_hasGuardian> :nth-child(1) > span > input').should('not.be.checked')
		cy.get('#normal_login_hasGuardian> :nth-child(2) > span > input').should('not.be.checked')
		return this
	}

	verifyGuardianYesSelected() {
		cy.get('#normal_login_hasGuardian> :nth-child(1) > span > input').should('be.checked')
		cy.get('#normal_login_hasGuardian> :nth-child(2) > span > input').should('not.be.checked')
		return this
	}
	...
	verifyGuardianNoSelected() {
		cy.get('#normal_login_hasGuardian> :nth-child(1) > span > input').should('not.be.checked')
		cy.get('#normal_login_hasGuardian> :nth-child(2) > span > input').should('be.checked')
		return this
	}
	...
	verifyVisitedBeforeIsEmpty() {
		cy.get('#normal_login_returnPatient > :nth-child(1) > span > input').should('not.be.checked')
		cy.get('[data-testid="returnPatientNo"]').should('not.be.checked')
		return this
	}

	verifyVisitedBeforeYesSelected() {
		cy.get('#normal_login_returnPatient > :nth-child(1) > span > input').should('be.checked')
		cy.get('[data-testid="returnPatientNo"]').should('not.be.checked')
		return this
	}
	...
	verifyMedicalPatientIsEmpty() {
		cy.get('#normal_login_medicarePatient > :nth-child(1) > span > input').should('not.be.checked')
		cy.get('[data-testid="medicarePatientNo"]').should('not.be.checked')
		return this
	}

	verifyMedicalPatientYesSelected() {
		cy.get('#normal_login_medicarePatient > :nth-child(1) > span > input').should('be.checked')
		cy.get('[data-testid="medicarePatientNo"]').should('not.be.checked')
		return this
	}
	...
	validatePatientFirstName(placeholder) {
    	cy.get('[data-testid="first_name"]').should('not.have.value').and('have.attr', 'placeholder').and('eq', placeholder);
		return this
	}
	...
	validatePatientLastName(placeholder) {
    	cy.get('[data-testid="last_name"]').should('not.have.value').and('have.attr', 'placeholder').and('eq', placeholder);
		return this
	}
	...
	validateGuardianFirstName(placeholder) {
		cy.get('#normal_login_guardian_first_name').should('not.have.value').and('have.attr', 'placeholder').and('eq', placeholder);
		return this
	}

	validateGuardianLastName(placeholder) {
		cy.get('#normal_login_guardian_last_name').should('not.have.value').and('have.attr', 'placeholder').and('eq', placeholder);
		return this
	}

	validateGuardianRelationship(labelText) {
		cy.get('[for="normal_login_relationship_to_patient"]').should('have.text', labelText)
		return this
	}

	validateGuardianOptions(listOfOptions) {
        for(let i = 0; i < listOfOptions.length; i++)
		cy.get('#normal_login_relationship_to_patient-'+ i).should('have.text', listOfOptions[i])
		return this
	}
